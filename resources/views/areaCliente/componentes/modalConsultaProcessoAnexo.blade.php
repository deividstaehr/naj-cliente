<div class="modal fade" id="modal-anexo-processo" tabindex="-1" role="dialog" aria-hidden="true">
    ...
    <div class="modal-dialog modal-extra-large" role="document" style="min-width: 60% !important;">
        <div class="modal-content modal-content-shadow-naj">
            <div class="modal-header modal-header-naj">
                <p class="titulo-modal-naj">Anexos do Processo</p>
            ...
            <div class="modal-body-naj p-0">                
                ...
                <div id="datatable-anexos-processo" class="p-0 m-0 naj-datatable"></div>
            </div>
        </div>
    </div>
</div>