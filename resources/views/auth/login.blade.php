                            ...
                            <div class="row">
                                <div class="col-12">
                                    <form class="form-horizontal mt-2" id="loginform" method="post" action="login">
                                        ...
                                        <div>
                                            <span style="cursor: pointer; margin-left: 8%;" onclick="onClickCadastroLogin();"><i class="fas fa-user-plus"></i> Não tem login? <a href="#" class="text-info"><b>Clique aqui e se cadastre!</b></a></span>
                                        </div>
                                        
                                        <div class="mt-3">
                                            <span style="cursor: pointer; margin-left: 10%;" onclick="onClickModalEsqueceuLogin();"><i class="fas fa-lock mr-1"></i>Esqueceu o login ou a senha? <a href="#" class="text-info"><b>Clique aqui!</b></a></span>
                                        </div>
