...
class FinanceiroPagarModel extends NajModel {
    ...
    public function getTotalPagoPagarAtrasado($parametro) {
        ...
        $total_aberto = DB::select("
            ...
            INNER JOIN NATUREZA_FINANCEIRA N
                 ...
                 WHERE CP.SITUACAO IN('A')
                   ...
                   AND (
                        CP.DATA_VENCIMENTO BETWEEN '{$parametro->data_inicial}' and '{$parametro->data_final}'                        
                        #ERA ASSIM MAS FOI TROCADO POR QUE NÃO TAVA EXIBINDO CERTO NO CLIENTE 156
                      )
        ");
        ...
        return ['total_pago' => $total_pago[0], 'total_aberto' => $total_aberto[0], 'total_atrasado' => $total_atrasado[0]];
    }
